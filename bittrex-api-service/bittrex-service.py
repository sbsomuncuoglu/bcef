...
def main():
  with open('config.json') as config_json:
    ...
    schedule.every(2).minutes.do(stream_prices, api_url_base=_api_url_base, currencies=_currencies, targetCurrency=_targetCurrency, kafkaProducer=_kafkaProducer)
    while True:
