...
try:
  #print("Running bittrex-consumer.py")
  with open('config.json') as config_json:
    ...
    consumer = KafkaConsumer('Bittrex', bootstrap_servers = kafkaBrokerIpPort)
    ...
    for message in consumer:
      ...
      session.execute(
        """
          INSERT INTO Bittrex (coin_id, price_timestamp, buy_price, sell_price)
